...
export const LNavBar: React.FC<LNavBarProps> = ({ icon }) => {
  return (
    <div className="absolute fixed left-1/2 transform -translate-x-1/2 md:fixed md:top-1/2 md:right-4 md:left-auto md:transform md:-translate-y-1/2 md:translate-x-0 bottom-4 md:bottom-auto ">
      <Card className="w-auto p-3 rounded-full flex flex-row md:flex-col items-center space-x-4 md:space-y-4 md:space-x-0">
        ...
        <div className={`flex items-center justify-center rounded-full ${icon === 2 ? "border-black border-2" : "border-gray-300"}`}>
